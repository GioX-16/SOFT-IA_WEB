...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (aboutSection) {
        setShowNavbar(aboutSection.getBoundingClientRect().top <= 0);
      }
    };

    const handleHashChange = () => {
      const hash = window.location.hash.replace("#", "");
      setShowNavbar(hash !== "" && hash !== "top");
    };
                ...
                <a
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background =
                      "linear-gradient(90deg, #1F2E36 60%, #336178 100%)";
            ...
            >
              {NAV_ITEMS.map((item) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = item.isButton
                      ? "#E9ECF0"
